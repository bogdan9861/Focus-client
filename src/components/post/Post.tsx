...
import { useGetCommentsMutation } from "../../app/service/posts";
...
export const Post = ({
  ...
  return (
    <div className="feed__post">
      <div className="feed__post-top">
        <Link className="feed__post-profile" to={`/profile/${userId}`}>
          ...
          <div className="feed__post-profile-info">
            ...
            <span className="feed__post-profile-status">новая публикация</span>
          </div>
        </Link>
        {!self ? (
      ...
      <Comments id={id} setCommentsCount={setCommentsCount} />
...
const Comments = ({ id, setCommentsCount }) => {
    ...
    <div className="feed__comments">
      <ul className="feed__comments-list">
        {comments.map((comment: any) => {
          return (
            <li className="feed__comments-item">
